	...
	<div style={{ width: '700px', display: 'flex', justifyContent: 'center' }}>
		...
		<div style={{ width: '380px' }}>
			<Card href=" " hrefText="Handling">
				<Text>
					Explain something about something with something clever. Men denne har mye mere tekst så
					den kommer til å bli lengre
				</Text>
			</Card>
		</div>
	</div>
...
export const DefaultProfiledCardMedTittel = () => (
	<div style={{ width: '800px', display: 'flex', justifyContent: 'center' }}>
		...
		<div style={{ width: '380px', marginLeft: '10px' }}>
			<p>
				Hvis man legger på attributt ariaDescribedBy="text": Title + Text ( Explain something….)
			</p>
...
export const DefaultProfiledCardWithoutTitleButWithHrefText = () => (
	<div style={{ width: '1200px', display: 'flex', justifyContent: 'center' }}>
		...
		<div style={{ width: '380px', marginLeft: '10px' }}>
			<p>
				Hvis man legger på attributt ariaDescribedBy="text": Gå til en annen side + Text ( Explain
				something….)
			</p>
			<Card
				href=" "
...
export const CardWithImages = () => (
	<div
		style={{ width: '800px', display: 'flex', justifyContent: 'center', flexDirection: 'column' }}
	>
		<div>
		...
		<div>
			<p>
				<s>
					Hvis man legger på attributt ariaDescribedBy="subtitle": Tittel + Artikkel / 11. mai 2019{' '}
				</s>{' '}
				(Hvis man ønsker å endre hvordan dato leses opp må man heller bruke ariaLabel til å sette
				sammen Tittel og subtitle slik man ønsker)
			</p>
			<Card
				imagePlacement="left"
				image={<img src="/16x9.png" alt="testImage" />}
